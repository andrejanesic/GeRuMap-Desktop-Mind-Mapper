...
public class RedoAction extends IAction {
    @Override
    public void actionPerformed(ActionEvent e) {
        ...
        if (!cm.canRedo()) {
            AppCore.getInstance().getMessageGenerator().error("No action to redo on this mind map!");
            return;
        }

        cm.redoCommand();
        AppCore.getInstance().getMessageGenerator().log("Action redone");
    }
}
